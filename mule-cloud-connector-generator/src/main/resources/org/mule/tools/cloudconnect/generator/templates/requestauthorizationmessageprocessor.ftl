...
public class RequestAuthorizationMessageProcessor implements MessageProcessor, Initialisable, MuleContextAware
{
    ...
    public String toString()
    {
        return String.format(
            "RequestAuthorizationMessageProcessor [object=%s]", object);
    }
