...
public class SetAuthorizationCodeOperationDefinitionParser extends ChildDefinitionParser
{
    public SetAuthorizationCodeOperationDefinitionParser()
    {
        super("messageProcessor", SetAuthorizationCodeMessageProcessor.class);
    }

    @Override
    protected Class getBeanClass(Element element)
    {
        return SetAuthorizationCodeMessageProcessor.class;
    }
    ...
    protected void parseChild(Element element, ParserContext parserContext, BeanDefinitionBuilder builder)
    {
        ...
        builder.addPropertyValue("code", getAttributeValue(element, "code"));
