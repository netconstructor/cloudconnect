...
public class HasBeenAuthorizedOperationDefinitionParser extends ChildDefinitionParser
{
    public HasBeenAuthorizedOperationDefinitionParser()
    {
        super("messageProcessor", HasBeenAuthorizedMessageProcessor.class);
    }

    @Override
    protected Class getBeanClass(Element element)
    {
        return HasBeenAuthorizedMessageProcessor.class;
    }
