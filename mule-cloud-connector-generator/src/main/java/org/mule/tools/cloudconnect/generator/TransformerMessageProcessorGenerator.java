...
public class TransformerMessageProcessorGenerator extends AbstractTemplateGenerator
{

    private static final String NAMESPACE_HANDLER_TEMPLATE = "transformermessageprocessor.ftl";
